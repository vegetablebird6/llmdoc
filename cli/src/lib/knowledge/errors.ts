export type KnowledgeErrorCode =
  ...
  | "E_SOURCE_DIRTY"
  | "E_SOURCE_HEAD_DRIFT"
  | "E_SOURCE_INVALID_HEAD"
  | "E_KNOWLEDGE_INDEX_DIRTY"
  | "E_KNOWLEDGE_HEAD_MISMATCH"
  | "E_KNOWLEDGE_NOT_ON_BRANCH"
  | "E_KNOWLEDGE_META_DIRTY"
  | "E_KNOWLEDGE_LOCKED"
  | "E_INDEX_LOCKED"
  | "E_REVIEW_NOT_FOUND"
  | "E_REVIEW_INVALID"
  | "E_REVIEW_NOT_CONFIRMED"
  | "E_REVIEW_INVALIDATED"
  | "E_PRUNE_INSUFFICIENT"
  | "E_CANDIDATE_UNCOMMITTED"
  | "E_DOCUMENT_EXISTS"
  | "E_MIGRATION_TARGET_OVERLAP"
  | "E_MIGRATION_TARGET_LOCKED"
  | "E_MIGRATION_TARGET_DIRTY"
  | "E_LEGACY_CHANGED"
  | "E_CAS_CONFLICT"
  | "E_KNOWLEDGE_WRITE_FAILED";
